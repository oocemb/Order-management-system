...
class PostDetail(ObjectDetailMixin, View):
    ...
    # a = get_object_or_404(Calc, id= calc_id)
...
def index(request):
    ...
    page_number = request.GET.get('page', 1) # дефольт начение если не нашёл в запросе этот параметр
    ...
    if page.has_next():
        ...
        next_url = ''
    return render(request, 'calc/index.html', context={'posts':page, 'is_paginated': is_paginated, 'next_url':next_url, 'prev_url':prev_url})  # object_list текущие страницы
